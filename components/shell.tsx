...
import {cities,serviceGroups,brand} from '@/lib/config';
 ...
 return <footer className="site-footer"><div className="container">
  <div className="sf-top">
   <div className="sf-brand"><Link href="/" aria-label="Raftaar One home" className="sf-logo"><span className="logo-app" role="img" aria-label="Raftaar logo"/></Link><p>A little less hassle.<br/>A lot more Pakistan.</p>
    <div className="sf-social"><a href={'mailto:'+brand.email} aria-label="Email"><FiMail/></a><a href="tel:+923181014996" aria-label="Call"><FiPhone/></a><a href={'https://github.com/'+brand.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub"><FaGithub/></a></div></div>
   <nav className="sf-cols" aria-label="Footer">
    <div><strong>Cities</strong>{cities.map(c=><Link key={c} href="/book">{c}</Link>)}</div>
    ...
    <div><strong>Earn with us</strong><Link href="/partner">Become a driver</Link><Link href="/partner">Become a courier</Link><Link href="/partner">Become a merchant</Link><Link href="/partner">Fleet operators</Link></div>
    <div><strong>For riders</strong><Link href="/book">Book a ride</Link><Link href="/account">My account</Link><Link href="/cart">Cart</Link><Link href="/help">FAQ & help</Link></div>
    <div><strong>Company</strong><Link href="/privacy">Privacy policy</Link><Link href="/terms">Terms & cancellations</Link><Link href="/help">Support</Link><a href={'mailto:'+brand.email}>Contact us</a></div>
   </nav>
  </div>
