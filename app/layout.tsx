...
export const metadata:Metadata={metadataBase:new URL(process.env.NEXT_PUBLIC_SITE_URL||'http://localhost:3000'),title:{default:'Raftaar One | Your city. One connection.',template:'%s | Raftaar One'},description:'A Pakistan-focused platform for ride requests, food, everyday shopping and cargo. Discover Raftaar One by Usaid Ahmed.',icons:{icon:'/images/logo.png',apple:'/images/logo.png'},robots:{index:launchReady,follow:launchReady},openGraph:{title:'Raftaar One',description:'Your city. One connection.',type:'website',locale:'en_PK',images:[{url:'/opengraph-image',width:1200,height:630}]}};
