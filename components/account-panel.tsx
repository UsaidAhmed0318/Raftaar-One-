...
type RideRow={id:string;service:string;status:string;pickup_text:string;dest_text:string;offer:number;agreed_fare:number|null;created_at:string;role:string};
