...
test('ride pages and components exist',()=>{for(const p of ['app/ride/page.tsx','app/driver/page.tsx','components/ride-rider.tsx','components/driver-dashboard.tsx','components/map.tsx','app/api/route/route.ts','app/api/places/route.ts','app/api/reverse/route.ts'])assert.ok(fs.existsSync(p),p);});
