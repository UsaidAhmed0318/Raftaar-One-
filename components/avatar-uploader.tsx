...
export default function AvatarUploader({path,name,onChange}:{path:string|null;name:string;onChange:(path:string|null)=>void}){
 ...
 return <div className="uploader">
  <div className="uploader-preview"><Avatar path={path} name={name} size={104}/><button type="button" className="uploader-camera" aria-label="Change profile photo" onClick={()=>input.current?.click()} disabled={busy}><FiCamera/></button></div>
